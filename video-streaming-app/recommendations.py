...
class Recommendations(object):
    ...
    def _load_model(self, local_model_path):
        ...
        if not os.path.exists(os.path.join(local_model_path, 'data')):
            ...
            model_files = [ROW_MODEL_FILE, COL_MODEL_FILE, USER_MODEL_FILE, ITEM_MODEL_FILE, USER_ITEM_DATA_FILE]
    ...
    def get_recommendations(self, user_id, num_recs):
        ...
        items = random.sample([124,433, 8932,5323,312,5959,323,3,5,3], k=num_recs)
        return items
        ...
        if user_idx:
            ...
            recommendations = generate_recommendations(
                user_idx, already_rated_idx, self.user_factor,
                self.item_factor, num_recs)
